...
Fixed all the meaningful sparse warnings of the EMXX-UDC driver in the staging directory of Linux 4.19-rc5.
1. Added io_mem modifier for code that handles memory mapped from an IO device. See https://lwn.net/Articles/102232/ for details.
